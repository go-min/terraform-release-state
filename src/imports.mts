...
export function candidatesFromState(state: TerraformState): {
  ...
  if (!Array.isArray(state.resources)) {
    fail("state-path does not contain a Terraform state resources array.");
  }
...
export async function generateImports(
  ...
  const outputPath = join(config.importsPath, config.importsFile);
  ...
  core.info("StateImport: proposed diff (file was not modified):");
